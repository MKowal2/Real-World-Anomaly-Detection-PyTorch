...
parser.add_argument('--annotation_path', default="/mnt/zeta_share_1/m3kowal/AnomalyDetectionCVPR2018-Pytorch/Train_Annotation.txt",
                    help="path to train annotation")
parser.add_argument('--annotation_path_test', default="/mnt/zeta_share_1/m3kowal/AnomalyDetectionCVPR2018-Pytorch/Test_Annotation.txt",
