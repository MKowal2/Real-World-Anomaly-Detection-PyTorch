...
# parser.add_argument('--video_path_list', default=["/mnt/zeta_share_1/m3kowal/UCF_Crimes/Videos/Fighting/Fighting043_x264.mp4", "/mnt/zeta_share_1/m3kowal/UCF_Crimes/Videos/Fighting/Fighting051_x264.mp4"],
parser.add_argument('--video_path_list', default=["/mnt/zeta_share_1/m3kowal/UCF_Crimes/Videos/Fighting/Fighting043_x264.mp4"],
...
parser.add_argument('--model_dir', default='/mnt/zeta_share_1/m3kowal/AnomalyDetectionCVPR2018-Pytorch/exps/model',
                    help="path to the trained AD model")


args = parser.parse_args()

video_path_list = args.video_path_list
...
def cd3_extartion(video_path,device=None):
    ...
    home=os.getcwd()
    pretrained_3d=home+"/network/c3d.pickle"
...
def AD_perdiction(model_dir,dir_list,device=None):
    ...
    annotation_path=annotatate_file(video_path,dir_list,normal=[True, True],file_name="Demo_anmotation")
...
def GUI(video_path,y_pred,save="Just save",s_path="/mnt/zeta_share_1/m3kowal/AnomalyDetectionCVPR2018-Pytorch/demo_video/demovid"):
...
if __name__ == '__main__':
    ...
    features_dir=args.features_dir
    model_dir=args.model_dir
    root = '/mnt/zeta_share_1/m3kowal/AnomalyDetectionCVPR2018-Pytorch/'


    # from os import listdir
    # from os.path import isfile, join
    # mypath="/media/peter/Maxtor/UCF_Crimes/Videos/Fighting"
    # #video_path_list = [mypath+"/"+f for f in listdir(mypath) if isfile(join(mypath, f))]
    # #print("lenght "+str(len(video_path_list)))
    #video_path_list=["/media/peter/Maxtor/UCF_Crimes/Videos/Fighting/Fighting039_x264.mp4"]
    ...
    for video_path in video_path_list:
        dir_list=cd3_extartion(video_path,device=device)
        y_pred=AD_perdiction(model_dir, dir_list, device=device)

        import pickle
        print('Saving to: ', home+features_dir[1:]+"/"+dir_list[0][0]+"/"+dir_list[0][1]+'_y_pred.pkl')
        ...
        GUI(video_path, y_pred,save="Just save",s_path=root + features_dir.split('/')[1]+'/'+dir_list[0][0]+"/"+dir_list[0][1]+"_demo")
